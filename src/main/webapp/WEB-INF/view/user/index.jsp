	...
	<div class="content">
		...
		<div id="sessions-1">
			...
			<div class="button_link">
				<div class="download">
					<a target="_blank">
						<canvas id="canvas_button"
							style="position: absolute; top: 0px; left: 0px;" width="241"
							height="126"></canvas>
					</a>
				</div>
				<div class="resgiter">
					<a data-fancybox-type="iframe" class="various"
						href="/CUUDUONGTHANCONG/register">Đăng ký</a>
				</div>
				<div class="card">
					<a href="#">Nạp thẻ</a>
				</div>
			...
			<div class="slider-link">
				<div id="boxEvent">
					<ul id="img">
						<li class="ActiveBanner"><a href="" alt="" target="_blank">
								<span class="BorderEvent"></span> <img width="491" height="253"
								title="" alt=""
								src="<c:url value="/cuuduong.gosu.vn/home/images/sk1.jpg"/>">
						</a></li>
						<li class=""><a href="" alt="" target="_blank"> <span
								class="BorderEvent"></span> <img width="491" height="253"
								title="" alt=""
								src="<c:url value="/cuuduong.gosu.vn/home/images/sk1.jpg"/>">
						</a></li>
						<li class=""><a href="" alt="" target="_blank"> <span
						...
						<li class=""><a href="" alt="" target="_blank"> <span
								class="BorderEvent"></span> <img width="491" height="253"
								title="" alt=""
								src="https://cuuam.gosu.vn/home/static/uploads/2022/mcm-trieu-man/7_-491x253.gif">
						</a></li>
						<li class=""><a href="" alt="" target="_blank"> <span
								class="BorderEvent"></span> <img width="491" height="253"
								title="" alt=""
								src="<c:url value="/cuuduong.gosu.vn/home/images/sk4.jpg"/>">
						</a></li>
					</ul>

					<ul id="imgControl">
						<li id="item1"><a href="" alt="" target="_blank">1</a></li>
						<li id="item2"><a href="" alt="" target="_blank">1</a></li>
						<li id="item3"><a href="" alt="" target="_blank">1</a></li>
						<li id="item4"><a href="" alt="" target="_blank">1</a></li>
						<li id="item5"><a href="" alt="" target="_blank">1</a></li>
					</ul>
				</div>
			</div>
			<!-- slider-link end -->
			...
			<div class="event-link">
				<div class="giangho">
					<a target="_blank">Giang hồ kỳ bảo</a>
				</div>
				<div class="support">
					<a target="_blank">Hỗ trợ</a>
				</div>
				<div class="giftcode">
					<a target="_blank">Giftcode</a>
				</div>
				<div class="vip">
					<a target="_blank">VIP</a>
					<!-- https://id.gosu.vn/Cuuam/VIP -->
				</div>
			...
			<div class="session-left">
				...
				<div class="news-link">
					<ul class='tabs-news'>
						...
						<!-- <li class="tab-news"><h2>
								<a class="tbnews" href='#tab1-news'>Tin mới</a>
							</h2></li>
						<li class="tab-news"><h2>
								<a class="tbnews" href='#tab2-news'>Thông báo</a>
							</h2></li>
						<li class="tab-news"><h2>
								<a class="tbnews" href='#tab3-news'>Sự kiện</a>
							</h2></li>
						<li class="tab-news"><h2>
								<a class="tbnews" href='#tab4-news'>Cộng đồng</a>
							</h2></li>
						<li class="tab-news"><h2>
								<a class="tbnews" href='#tab5-news'>Báo chí</a>
							</h2></li>
						<li class="tab-news"><h2>
								<a class="tbnews" href='#tab6-news'>Hướng dẫn</a>
							</h2></li>  -->

					</ul>
					<!-- <li class="details_news"><a class="tbnews"
						href="https://cuuam.gosu.vn/home/news/tin-moi.html"
						target="_blank">+</a></li> -->
					...
					<div class="news-content-tab" id='tab1-news'>
						...
						<div class="page">
							...
							<div class="details">
								<a href="/CUUDUONGTHANCONG/view">Xem thêm</a>
							</div>
						</div>
					...
					<div class="news-content-tab" id='tab2-news'>
						...
						<div class="page">
							...
							<div class="details">
								<a href="/CUUDUONGTHANCONG/view"> <!-- href="https://cuuam.gosu.vn/home/news/thong-bao.html" -->Xem
									thêm
								</a>
							</div>
						</div>
			...
			<div class="session-right">
				...
				<div class="box-special">
					<div class="title-link">
						<span class="icon-title"></span>Đặc sắc
					</div>
					...
					<ul class="special-content">
						...
						<li><a
							href="#">Không
								cấp độ</a></li>
						<li><a href="/CUUDUONGTHANCONG/vohoc">Võ học</a></li>
						<li><a
							href="#">Khinh
								công</a></li>
						<li><a
